...
% specific volume for lean to rich CH4-air mixtures at standard conditions,
...
% Define properties
mixArray = setProperties(mix, 'temperature', 300, 'volume', 1, 'equivalenceRatio', 0.5:0.01:5);
