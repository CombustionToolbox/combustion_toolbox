function problems_solved = run_validation_ROCKET_CEA_10
    % Run test validation_ROCKET_CEA_10:
    ...
    Aratio = 2;
    prefixDataName = 'RP1';
    filename = {strcat(prefixDataName, '_LOX_A10_ROCKET1.out'), strcat(prefixDataName, '_LOX_A10_ROCKET2.out')};
