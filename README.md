...
**Figure 4:** *Pressure-deflection shock polar for an air mixture (79% N2, 21% O2), and a range of preshock Mach numbers M1 = [2, 14]; line: considering dissociation, ionization, and recombination in multi-species mixtures; dashed: considering a thermochemically frozen air mixture.*
...
@misc{combustiontoolbox,
    ...
    year = 2022,
    note = "Version 0.8.7",
    doi = {https://doi.org/10.5281/zenodo.6365675}
}
```
