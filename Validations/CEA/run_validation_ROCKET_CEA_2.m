function problems_solved = run_validation_ROCKET_CEA_2
    % Run test validation_ROCKET_CEA_2:
    ...
    Aratio = 1.2;
    prefixDataName = 'RP1';
    filename = {strcat(prefixDataName, '_LOX_A2_ROCKET1.out'), strcat(prefixDataName, '_LOX_A2_ROCKET2.out')};
