...
## Examples
We have several examples of what Combustion Toolbox can do. Here we show some plots obtained from Combustion Toolbox.
...
@misc{combustiontoolbox,
    ...
    year = 2021,
    note = "Version 0.3.72",
    doi = {https://doi.org/10.5281/zenodo.5592828}
}
```
