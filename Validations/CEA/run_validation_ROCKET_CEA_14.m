function problems_solved = run_validation_ROCKET_CEA_14
    % Run test validation_ROCKET_CEA_14:
    ...
    Aratio = 2.4;
    prefixDataName = 'RP1';
    filename = {strcat(prefixDataName, '_LOX_A14_ROCKET1.out'), strcat(prefixDataName, '_LOX_A14_ROCKET2.out')};
