function [str1,str2,guess] = SolveProblemDET_Jouget_main(strR,phi,p1,T1,guess,E,S,C,M,PD,TN,strThProp)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
while  ((counter <= 3) || (g < 0.99999))
    ...
    for x = min:step:max
        [str1,str2,guess_shock] = SolveProblemDET_Jouget_inloop(strR,phi,p1,T1,x,guess,E,S,C,M,PD,TN,strThProp);
        w1(i) = str1.u;
