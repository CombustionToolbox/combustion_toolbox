function [str1,str2,guess] = SolveProblemDET_fast(strR,phi,p1,T1,guess,str1_i1,str2_i1,E,S,C,M,PD,TN,strThProp)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
while  ((counter <= 3) || (g < 0.99999))
    ...
    for x = min:step:max
        [str1,str2] = SolveProblemDET_fast_inloop(strR,phi,p1,T1,x,guess,str1_i1,str2_i1,E,S,C,M,PD,TN,strThProp);
        w1(i) = str1.u;
...
U_cj = cj_speed + .01;  %Make sure Hugoniot and Rayleigh intersect
[str1,str2] = SolveProblemSHOCK_I_test(strR,phi,p1,T1,U_cj,E,S,C,M,PD,TN,strThProp);
% [str1,str2] = SolveProblemSHOCK_I_fast(strR,phi,p1,T1,U_cj,str2_i1,E,S,C,M,PD,TN,strThProp);
