function metadata = run_validation_SHOCK_PRANDTL_MEYER_SDToolbox_1(varargin)
    % Run test validation_SHOCK_PRANDTL_MEYER_SDToolbox_1
    % Contrasted with: Caltech's SD Toolbox and CANTERA
    % Problem type: Shock Prandtl-Meyer expansion (chemical equilibrium)
    % Temperature [K]   = 3000
    % Pressure    [bar] = 1
    ...
    % Definitions
    filename = 'shock_prandtlmeyer_equilwithions_SDToolbox1';
