function [max_rel_error_moles, max_rel_error_prop] = run_test_TV_CEA_1(value, database)
    % Run test_TV_CEA_1:
    ...
    % Define properties
    mixArray = setProperties(mix, 'temperature', 3000, 'volume', 1, 'equivalenceRatio', value);
