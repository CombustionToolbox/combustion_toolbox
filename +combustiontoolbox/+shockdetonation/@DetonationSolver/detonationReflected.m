function [mix1, mix2, mix5] = detonationReflected(obj, mix1, mix2, varargin)
    ...
    try
        [T5, p5, STOP, it] = solve_detonation_reflected(FLAG_FAST);
    ...
    % NESTED-FUNCTIONS
    function [T5, p5, STOP, it] = solve_detonation_reflected(FLAG_FAST)
        % Miscellaneous
