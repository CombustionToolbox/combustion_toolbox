function problems_solved = run_validation_ROCKET_CEA_7
    % Run test validation_ROCKET_CEA_7:
    ...
    Aratio = 1.7;
    prefixDataName = 'RP1';
    filename = {strcat(prefixDataName, '_LOX_A7_ROCKET1.out'), strcat(prefixDataName, '_LOX_A7_ROCKET2.out')};
