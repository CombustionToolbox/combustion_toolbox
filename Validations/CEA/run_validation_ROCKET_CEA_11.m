function problems_solved = run_validation_ROCKET_CEA_11
    % Run test validation_ROCKET_CEA_11:
    ...
    Aratio = 2.1;
    prefixDataName = 'RP1';
    filename = {strcat(prefixDataName, '_LOX_A11_ROCKET1.out'), strcat(prefixDataName, '_LOX_A11_ROCKET2.out')};
