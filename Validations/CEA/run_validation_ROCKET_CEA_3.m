function problems_solved = run_validation_ROCKET_CEA_3
    % Run test validation_ROCKET_CEA_3:
    ...
    Aratio = 1.3;
    prefixDataName = 'RP1';
    filename = {strcat(prefixDataName, '_LOX_A3_ROCKET1.out'), strcat(prefixDataName, '_LOX_A3_ROCKET2.out')};
