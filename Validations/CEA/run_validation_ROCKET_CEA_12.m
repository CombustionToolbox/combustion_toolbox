function problems_solved = run_validation_ROCKET_CEA_12
    % Run test validation_ROCKET_CEA_12:
    ...
    Aratio = 2.2;
    prefixDataName = 'RP1';
    filename = {strcat(prefixDataName, '_LOX_A12_ROCKET1.out'), strcat(prefixDataName, '_LOX_A12_ROCKET2.out')};
