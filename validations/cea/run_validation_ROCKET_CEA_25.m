function problems_solved = run_validation_ROCKET_CEA_25
    ...
    Aratio = 8;
    prefixDataName = 'H2';
    filename = {[prefixDataName, '_LOX_A2_ROCKET_IAC1_FROZEN.out'], [prefixDataName, '_LOX_A2_ROCKET_IAC2_FROZEN.out']};
    LS =  'HYDROGEN_L';
