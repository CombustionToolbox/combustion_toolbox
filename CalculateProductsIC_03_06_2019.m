function N_IC = CalculateProductsIC_03_06_2019(P_CC,TP,pP,vP,phi,minor_products,phi_c,FLAG_SOOT,M0,A0,E,S,C,M,PD,TN,strThProp)
...
%                     NO2 = exp(log(NO2_old) +relax*(log(NO2) -log(NO2_old)));
                ...
                c = 2*NCO2_0+NCO_0+NH2O_0+2*NO2_0+N_minor_O_0-2*NO2-sum(N_IC(:,1).*A0(:,E.ind_O));
                d = b-c;
                ...
                a0 = DNfactor*(KPT_VII*(c-b)-KPT_IV*DNfactor);
                a1 = DNfactor*KPT_VII*(1+2*KPT_IV);
                a2 = 2*KPT_VII^2;
                a3 = c*KPT_IV*DNfactor^2;

                NCO = real(-(a1/(3*a2))-(2^(1/3)*(-a1^2-3*a0*a2))/(3*a2*(-2*a1^3-9*a0*a1*a2+27*a2^2*a3+sqrt(-4*(a1^2+3*a0*a2)^3+(2*a1^3+9*a0*a1*a2-27*a2^2*a3)^2))^(1/3))+(-2*a1^3-9*a0*a1*a2+27*a2^2*a3+sqrt(-4*(a1^2+3*a0*a2)^3+(2*a1^3+9*a0*a1*a2-27*a2^2*a3)^2))^(1/3)/(3*2^(1/3)*a2));
%                 NCO = real(-(a1/(3*a2))+((1-1i*sqrt(3))*(-a1^2-3*a0*a2))/(3*2^(2/3)*a2*(-2*a1^3-9*a0*a1*a2+27*a2^2*a3+sqrt(4*(-a1^2-3*a0*a2)^3+(-2*a1^3-9*a0*a1*a2+27*a2^2*a3)^2))^(1/3))-((1+1i*sqrt(3))*(-2*a1^3-9*a0*a1*a2+27*a2^2*a3+sqrt(4*(-a1^2-3*a0*a2)^3+(-2*a1^3-9*a0*a1*a2+27*a2^2*a3)^2))^(1/3))/(6*2^(1/3)*a2))
                NCO = (-DNfactor+ sqrt(DNfactor)*sqrt(DNfactor+4*a*KPT_VII))/(2*KPT_VII);
                NCO2 = a-NCO;
                NH2  = b-NH2O;
                NH2O = c-2*NCO2-NCO;
