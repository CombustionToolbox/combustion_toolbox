function problems_solved = run_validation_TP_TEA_2
    ...
    % Inputs
    load Validation_TP_TEA_2 Pressure Temp n_H n_He n_C n_N n_O n_S results_TEA
    Fuel = {'H', 'He', 'C', 'N', 'O', 'S'}; N_Fuel = [n_H, n_He, n_C, n_N, n_O, n_S];
    Oxidizer = {}; Inert = {};
    LS = {'C2H2_acetylene', 'C2H4', 'C', 'CH4', 'CO2', 'CO', 'H2', 'H2O', 'H2S', 'H', 'HCN', 'He', 'SH', 'N2', 'N', 'NH3', 'O'};
