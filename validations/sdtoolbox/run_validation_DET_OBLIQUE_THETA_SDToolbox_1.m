function metadata = run_validation_DET_OBLIQUE_THETA_SDToolbox_1(varargin)
    % Run test validation_DET_OBLIQUE_THETA_SDToolbox_1
    % Contrasted with: Caltech's SD Toolbox and CANTERA
    % Problem type: Oblique detonation wave given deflection angle
    % Temperature [K]   = 300
    ...
    % Define properties
    mixArray1 = setProperties(mix, 'temperature', 300, 'pressure', 1, 'equivalenceRatio', equivalenceRatio, 'driveFactor', driveFactor, 'theta', theta);
