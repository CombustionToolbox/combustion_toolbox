function problems_solved = run_validation_ROCKET_CEA_4
    % Run test validation_ROCKET_CEA_4:
    ...
    Aratio = 1.4;
    prefixDataName = 'RP1';
    filename = {strcat(prefixDataName, '_LOX_A4_ROCKET1.out'), strcat(prefixDataName, '_LOX_A4_ROCKET2.out')};
