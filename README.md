...
**Figure 1:** *Hugoniot curves for different molecular gases at pre-shock temperature <img src="https://render.githubusercontent.com/render/math?math=T_{1}=300%20K"> and pressure <img src="https://render.githubusercontent.com/render/math?math=p_{1}=1%20amt"> \[symbols: numerical results obtained with NASA’s Chemical Equilibrium with Applications (CEA) code excluding ionization\].*
