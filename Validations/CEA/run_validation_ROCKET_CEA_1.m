function problems_solved = run_validation_ROCKET_CEA_1
    ...
    Aratio = 1.1;
    prefixDataName = 'RP1';
    filename = {strcat(prefixDataName, '_LOX_A1_ROCKET1.out'), strcat(prefixDataName, '_LOX_A1_ROCKET2.out')};
