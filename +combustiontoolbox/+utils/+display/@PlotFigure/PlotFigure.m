classdef PlotFigure < combustiontoolbox.utils.display.Canvas
    % PlotFigure
    %
    % Unified class for plotting scalar fields or multiple properties.
    % Can handle plotting of one or more properties (e.g., cp, h, Xi)
    % against an independent variable (e.g., T, p, phi).
