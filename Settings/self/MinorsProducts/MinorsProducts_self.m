function app = MinorsProducts_self(varargin)
...
if nargin < 2
    ...
    elseif strcmpi(minors, 'SOOT FORMATION')
        app.M.minors_products = {'N2','H2O','CO','HCN','H2O','CO2','H','OH',...
                                 'O','CN','NH3','CH4','C2H4','CH3','NO','HCO',...
                                 'NH2','NH','N','CH','Cbgrb'};
    elseif strcmpi(minors, 'SOOT FORMATION EXTENDED')
    ...
    elseif strcmpi(minors, 'NASA ALL')
        app.M.minors_products = {'CH3','CH4','CN','CO2','C2H','CH2CO_ketene',...
    ...
    elseif strcmpi(minors, 'AIR')
        app.M.minors_products = {'O2','N2','O','O3','N','NO','NO2','NO3','N2O','N2O3','N2O4','N3','C','CO','CO2',...
                                'Ar','CH4','CH3','CH','H2O','H2','H','He'};
    elseif strcmpi(minors, 'IDEAL_AIR')
        app.M.minors_products = {'O2','N2','O','O3','N','NO','NO2','NO3','N2O','N2O3','N2O4','N3'};
    elseif strcmpi(minors, 'HYDROGEN')
        app.M.minors_products = {'H','HNO','HNO3','H2O','NH','NH2OH','NO3','N2H2','N2O3','N3','OH','HNO2',...
                                'H2','N','NH3','NO2','N2O','N2H4','N2O5','O','O3','He','Ar','CO2','CO','O2','N2','HO2','NH2','H2O2',...
                                'N3H','NH2NO2'};
    else
        app.M.minors_products = minors{1,1};
    end
