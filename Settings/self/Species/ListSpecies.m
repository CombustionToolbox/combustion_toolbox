...
elseif strcmpi(LS, 'SOOT FORMATION W/O CH4')
    app.S.LS = {'H2', 'H', 'O', 'O2', 'OH', 'H2O', 'HO2', 'H2O2',...
...
elseif strcmpi(LS, 'NASA ALL')
    app.S.LS = {'CH3','CH4','CN','CO2','C2H','CH2CO_ketene',...
