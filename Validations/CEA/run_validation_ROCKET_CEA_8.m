function problems_solved = run_validation_ROCKET_CEA_8
    % Run test validation_ROCKET_CEA_8:
    ...
    Aratio = 1.8;
    prefixDataName = 'RP1';
    filename = {strcat(prefixDataName, '_LOX_A8_ROCKET1.out'), strcat(prefixDataName, '_LOX_A8_ROCKET2.out')};
