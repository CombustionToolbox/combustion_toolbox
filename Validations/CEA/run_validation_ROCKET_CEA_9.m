function problems_solved = run_validation_ROCKET_CEA_9
    % Run test validation_ROCKET_CEA_9:
    ...
    Aratio = 1.9;
    prefixDataName = 'RP1';
    filename = {strcat(prefixDataName, '_LOX_A9_ROCKET1.out'), strcat(prefixDataName, '_LOX_A9_ROCKET2.out')};
