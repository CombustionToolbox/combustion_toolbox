function metadata = run_validation_ROCKET_CEA_18(varargin)
    ...
    % Define properties
    mixArray1 = setProperties(mix, 'temperature', 90, 'pressure', 101.325, 'equivalenceRatio', 0.5:0.01:4, 'areaRatioChamber', areaRatioChamber, 'areaRatio', areaRatio);
