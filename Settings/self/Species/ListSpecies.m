function self = ListSpecies(varargin)
    ...
    if exist('LS', 'var')
        ...
        elseif strcmpi(LS, 'AIR_IONS') | strcmpi(LS, 'AIR IONS')
            self.S.LS = {'CO2','CO','O2','N2','O','O3','N','NO','NO2',...
                'NO3','N2O','N2O3','N2O4','N3','eminus','Ar','Arplus',...
                'C','C2','C2N2','C2O','C2minus','C2plus','C3','CCN',...
                'CN','CNC','CNN','CNminus','CNplus','CO2plus','COplus',...
                'Cminus','Cplus','N2Oplus','N2minus','N2plus','NCN',...
                'NCO','NO2minus','NO3minus','NOplus','Nminus','Nplus',...
                'O2minus','O2plus','OCCN','Ominus','Oplus'};
        ...
        elseif strcmpi(LS, 'HC/O2/N2 PROPELLANTS')
            self.S.LS = {'CO2','CO','H2O','H2','O2','N2','He','Ar',...
                        'C2','CH','CH3','CH4','CN','H','H2bLb','HCN',...
                        'HCO','HO2','N','N2O','NH2','NH3','NO','NO2',...
                        'O','O2bLb','OH','RP_1'};
        else
            self.S.LS = LS;
        end
