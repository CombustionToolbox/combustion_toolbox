classdef PlotComposition < combustiontoolbox.utils.display.Canvas
    ...
    methods
        ...
        function [ax, fig] = plot(obj, mixture, x_var, x_field, y_field, varargin)
            ...
            [species, listSpecies] = obj.getDisplaySpecies(mixture, displaySpecies);
            ...
            [species, index_species_CT] = obj.cleanDisplaySpecies(mix1.Xi, listSpecies, index_species_CT, mintolDisplay, obj.FLAG_PLOT_VALIDATION);
    ...
    methods (Access = private, Static)
        ...
        function [species, listSpecies] = getDisplaySpecies(mixture, displaySpecies)
        ...
        function [species, index_pass] = cleanDisplaySpecies(molar_fractions, species, index_species, mintolDisplay, FLAG_PLOT_VALIDATION)
            % Remove species that do not appear
