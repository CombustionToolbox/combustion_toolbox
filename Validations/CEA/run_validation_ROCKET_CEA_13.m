function problems_solved = run_validation_ROCKET_CEA_13
    % Run test validation_ROCKET_CEA_13:
    ...
    Aratio = 2.3;
    prefixDataName = 'RP1';
    filename = {strcat(prefixDataName, '_LOX_A13_ROCKET1.out'), strcat(prefixDataName, '_LOX_A13_ROCKET2.out')};
