function problems_solved = run_validation_ROCKET_CEA_6
    % Run test validation_ROCKET_CEA_6:
    ...
    Aratio = 1.6;
    prefixDataName = 'RP1';
    filename = {strcat(prefixDataName, '_LOX_A6_ROCKET1.out'), strcat(prefixDataName, '_LOX_A6_ROCKET2.out')};
