function [str1,str2,guess] = SolveProblemDET_OVERDRIVEN(strR,phi,p1,T1,guess,E,S,C,M,PD,TN,strThProp,overdriven)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[str1.overdriven{i},str2.overdriven{i}] = SolveProblemSHOCK_Jouget_I(strR,phi,p1,T1,U_cj(i),E,S,C,M,PD,TN,strThProp);
if i==1
    % guess(1) = str2.T;
    % guess(2) = U_cj;
    guess(4) = min;
