 function [max_rel_error_prop_mix1, max_rel_error_prop_mix2] = run_test_SHOCK_IONIZATION_CEA_1(value, database)
    ...
    propertiesX = repmat({'u'}, 1, length(propertiesY));
    max_rel_error_prop_mix2 = compute_error_prop_CEA(mixArray2, resultsCEA, propertiesX, value, propertiesY, 'mix2');
end