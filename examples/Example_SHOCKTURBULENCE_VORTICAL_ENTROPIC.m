% Example of a Vortical-Entropic Shock-Turbulence Interaction
...
shockTurbulence = ShockTurbulenceSolver('problemType', 'vortical_entropic', 'FLAG_TCHEM_FROZEN', FLAG_TCHEM_FROZEN, 'FLAG_FROZEN', FLAG_FROZEN);

% Solve LIA
results = shockTurbulence.solve(mixArray, 'chi', 0);
