 function [max_rel_error_prop_mix1, max_rel_error_prop_mix2] = run_test_SHOCK_R_IONIZATION_CEA_1(value, DB, DB_master)
    ...
    tolN = 1e-14;
    % Combustion Toolbox
    results_CT = run_CT('ProblemType', 'SHOCK_R',...
                        'Species', LS,...
                        'S_Oxidizer', Oxidizer,...
                        'ratio_oxidizers_O2', moles,...
                        'u1', value,...
                        'tolN', tolN,...
                        'DB', DB,...
                        'DB_master', DB_master);
