function [mix2_inj, mix2_c, mix3] = rocketFAC(obj, mix1, mix2_inj, mix2_c, mix3)
    ...
    % Definitions
    Aratio_chamber = obj.PD.Aratio_c.value;
    ...
    mix2_inj = compute_chamber_IAC(obj, mix1, mix2_inj);
    ...
    % Loop
    while STOP > obj.TN.tol_rocket && it < obj.TN.it_rocket
        % Update iteration
        it = it + 1;
        % Get guess
        mix1.p = pressure_inf; % [bar]
        % Obtain mixture compostions
        [mix2_inf, mix3, mix2_c] = compute_IAC_model(obj, mix1, mix2_inf, mix3, mix2_c, Aratio_chamber);
        % Get results
...
function [mix2_inf, mix3, mix2_c] = compute_IAC_model(obj, mix1, mix2_inf, mix3, mix2_c, Aratio)
    % Solve IAC model
    obj.PD.FLAG_IAC = true;
    obj.PD.FLAG_SUBSONIC = true;
    mix2_inj = [];
    [~, mix2_inf, mix3, mix2_c] = solve_model_rocket(obj, mix1, mix2_inj, mix2_inf, mix3, mix2_c, Aratio);
end
